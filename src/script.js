...
function createItinerary(event) {
  ...
  let context =
    "You are a global travel expert and experienced travel guide. List 3 must go to attractions to see when visiting a city. Display using basic HTML <ul> <li> and the attractions <strong> ";
  ...
  loadingItinerary.classList.remove("hidden");
